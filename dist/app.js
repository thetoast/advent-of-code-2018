...
(function(exports) {
              ...
              return function (v) {
                  return Data_Maybe.Just.create((function () {
                      ...
                      if (accM instanceof Data_Maybe.Just) {
                          var $6 = Data_Ord.greaterThan(dictOrd)(accM.value0.value1)(v.value1);
                          if ($6) {
                              return accM.value0;
                          };
                          return v;
                      };
                      throw new Error("Failed pattern match at Util line 34, column 39 - line 36, column 60: " + [ accM.constructor.name ]);
                  })());
              };
          };
  ...
  var log$prime = function ($12) {
      return Control_Monad_Writer_Class.tell(Control_Monad_RWS_Trans.monadTellRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(Data_List.singleton($12));
  };
...
(function(exports) {
  ...
  var toOp = function (input) {
      ...
      throw new Error("Failed pattern match at Day1 line 23, column 5 - line 27, column 23: " + [ afterInt.constructor.name ]);
  };
  var opAndCheck = function (acc) {
      return function (op) {
          ...
          throw new Error("Failed pattern match at Day1 line 36, column 21 - line 42, column 67: " + [ acc.result.constructor.name ]);
      };
  };
  ...
  var solve2 = function ($copy_acc) {
      return function ($copy_ops) {
          ...
          function $tco_loop(acc, ops) {
              ...
              throw new Error("Failed pattern match at Day1 line 50, column 5 - line 52, column 35: " + [ res.result.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var part2 = Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)))(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Util["log'"]("Day 1 Part 2 started"))(function () {
          var ops = Data_Functor.map(Data_Functor.functorArray)(toOp)(Data_String_Common.split("\x0a")(v));
          return Control_Applicative.pure(Control_Monad_RWS_Trans.applicativeRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(Data_Maybe.Just.create(Data_Show.show(Data_Show.showInt)(solve2({
              sum: 0,
  ...
  var part1 = Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)))(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Util["log'"]("Day 1 Part 1 started"))(function () {
          return Control_Applicative.pure(Control_Monad_RWS_Trans.applicativeRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(Data_Maybe.Just.create(Data_Show.show(Data_Show.showInt)(solve(v))));
      });
  });
  exports["toOp"] = toOp;
...
(function(exports) {
  ...
  var part1 = Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)))(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Util["log'"]("Day2 part 1 started"))(function () {
          return Control_Applicative.pure(Control_Monad_RWS_Trans.applicativeRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(Data_Maybe.Just.create(Data_Show.show(Data_Show.showInt)(getSum(v))));
      });
  });
  ...
  var part2 = Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)))(function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Util["log'"]("Day2 part 2 started"))(function () {
          return Control_Applicative.pure(Control_Monad_RWS_Trans.applicativeRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(Data_Maybe.Just.create(Data_Show.show(Data_List_Types.showList(Data_Tuple.showTuple(Data_Tuple.showTuple(Data_Show.showString)(Data_Show.showString))(Data_Show.showArray(Data_Tuple.showTuple(Data_Show.showString)(Data_Show.showString)))))(collectDiffsOfN(1)(Data_List.fromFoldable(Data_Foldable.foldableArray)(getValidBoxes(v))))));
      });
  });
...
(function(exports) {
  ...
  var parseClaim = function (regex) {
      return function (str) {
          ...
          throw new Error("Failed pattern match at Day3 line 45, column 5 - line 47, column 30: " + [ v.constructor.name ]);
      };
  };
  ...
  var part1 = Data_Functor.map(Control_Monad_RWS_Trans.functorRWST(Data_Identity.functorIdentity))(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Maybe.Just.create)(Data_Show.show(Data_Show.showInt)))(solve1))(parseClaims))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)));
  var part2 = Data_Functor.map(Control_Monad_RWS_Trans.functorRWST(Data_Identity.functorIdentity))(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Data_Maybe.Just.create)(Data_Show.show(Data_Set.showSet(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "id";
      ...
      return "y";
  }))(Data_Show.showRecordFieldsNil)(Data_Show.showInt))(Data_Show.showInt))))(Data_Show.showInt))))))(solve2))(parseClaims))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)));
...
(function(exports) {
  ...
  var part1 = Data_Functor.map(Control_Monad_RWS_Trans.functorRWST(Data_Identity.functorIdentity))(function ($181) {
      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(solve1($181)));
  })(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)));
  ...
  var part2 = Data_Functor.map(Control_Monad_RWS_Trans.functorRWST(Data_Identity.functorIdentity))(function ($182) {
      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(solve2($182)));
  })(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)));
  exports["Guard"] = Guard;
  exports["Start"] = Start;
  exports["Sleep"] = Sleep;
...
(function(exports) {
  ...
  var pjoin = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Day5 line 53, column 1 - line 53, column 39: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var extract = function (pos) {
      return function (polymer) {
          ...
          throw new Error("Failed pattern match at Day5 line 39, column 10 - line 44, column 31: " + [ polymer.constructor.name ]);
      };
  };
  var dropAll = function (letter) {
      return function (string) {
          ...
          throw new Error("Failed pattern match at Day5 line 84, column 5 - line 86, column 25: " + [ v.constructor.name ]);
      };
  };
      ...
      return function ($copy_polymer) {
          ...
          function $tco_loop(pos, polymer) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Day5 line 75, column 27 - line 77, column 42: " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Day5 line 73, column 24 - line 77, column 42: " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var solve1 = function ($40) {
      return plength(condense(0)(makePolymer($40)));
  };
  var part1 = Data_Functor.map(Control_Monad_RWS_Trans.functorRWST(Data_Identity.functorIdentity))(function ($41) {
      return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(solve1($41)));
  })(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)));
  var solve2 = function (letter) {
      return function (input) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Util["log'"]("Solving for " + letter))(function () {
              var res = solve1(dropAll(letter)(input));
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Util["log'"](Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(res)))(function () {
                  return Control_Applicative.pure(Control_Monad_RWS_Trans.applicativeRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(res);
              });
          });
      };
  };
  var part2 = Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Util["log'"]("Calculating stage1s"))(function () {
      return Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)))(function (v) {
          return Control_Bind.bind(Control_Monad_RWS_Trans.bindRWST(Data_Identity.bindIdentity)(Data_List_Types.monoidList))(Data_Traversable.traverse(Data_Traversable.traversableArray)(Control_Monad_RWS_Trans.applicativeRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(Data_Function.flip(solve2)(v))(letters))(function (v1) {
              return Control_Applicative.pure(Control_Monad_RWS_Trans.applicativeRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(Data_Maybe.Just.create(Data_Show.show(Data_Maybe.showMaybe(Data_Maybe.showMaybe(Data_Show.showInt)))(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorFn)(Data_Array.head)(Data_Array.sort(Data_Ord.ordInt)))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(v1)))));
          });
      });
  });
...
(function(exports) {
  ...
  var makePoint = function (pattern) {
      return function (line) {
          ...
          throw new Error("Failed pattern match at Day6 line 34, column 26 - line 39, column 21: " + [ v.constructor.name ]);
      };
  };
  ...
  var solve1 = function (input) {
      var incCount = function (value) {
          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
              ...
              throw new Error("Failed pattern match at Day6 line 111, column 29 - line 115, column 1: " + [ value.constructor.name ]);
          })());
      };
  ...
  var part1 = Data_Functor.map(Control_Monad_RWS_Trans.functorRWST(Data_Identity.functorIdentity))(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Control_Applicative.pure(Data_Maybe.applicativeMaybe))(Data_Show.show(Data_Maybe.showMaybe(Data_Tuple.showTuple(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "x";
  }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
      return "y";
  }))(Data_Show.showRecordFieldsNil)(Data_Show.showInt))(Data_Show.showInt)))(Data_Show.showInt)))))(solve1))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)));
  var solve2 = function (input) {
  ...
  var part2 = Data_Functor.map(Control_Monad_RWS_Trans.functorRWST(Data_Identity.functorIdentity))(Data_Functor.map(Data_Functor.functorFn)(Data_Functor.map(Data_Functor.functorFn)(Control_Applicative.pure(Data_Maybe.applicativeMaybe))(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))))(solve2))(Control_Monad_Reader_Class.ask(Control_Monad_RWS_Trans.monadAskRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList)));
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var Util = PS["Util"];                 
  var part2 = Control_Applicative.pure(Control_Monad_RWS_Trans.applicativeRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(new Data_Maybe.Just("Part 2"));
  var part1 = Control_Applicative.pure(Control_Monad_RWS_Trans.applicativeRWST(Data_Identity.monadIdentity)(Data_List_Types.monoidList))(new Data_Maybe.Just("Part 1"));
  exports["part1"] = part1;
  exports["part2"] = part2;
})(PS["Day7"] = PS["Day7"] || {});
(function(exports) {
      ...
      return function (v) {
          return function (v1) {
              return function __do() {
                  ...
                  var v3 = Control_Monad_RWS.runRWS(func)(v2)({});
                  var v4 = Data_Traversable.traverse(Data_List_Types.traversableList)(Effect.applicativeEffect)(Effect_Console.log)(v3.value2)();
                  if (v3.value1 instanceof Data_Maybe.Just) {
                      return Control_Bind.bindFlipped(Effect.bindEffect)(JQuery.setText(v3.value1.value0))(JQuery.select("#results"))();
                  };
                  if (v3.value1 instanceof Data_Maybe.Nothing) {
                      return Control_Bind.bindFlipped(Effect.bindEffect)(JQuery.setText("Nothing"))(JQuery.select("#results"))();
                  };
                  throw new Error("Failed pattern match at Main line 44, column 7 - line 48, column 1: " + [ v3.value1.constructor.name ]);
              };
          };
      };
  };
