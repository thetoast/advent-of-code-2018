          ...
          var gt = function (accM) {
              return function (v) {
                  return Data_Maybe.Just.create((function () {
                      ...
                      throw new Error("Failed pattern match at Util line 31, column 39 - line 33, column 57: " + [ accM.constructor.name ]);
                  })());
              };
          };
...
(function(exports) {
  ...
  var parseClaim = function (regex) {
      return function (str) {
          ...
          throw new Error("Failed pattern match at Day3 line 43, column 5 - line 45, column 30: " + [ v.constructor.name ]);
      };
  };
...
(function(exports) {
  ...
  var pjoin = function (v) {
      return function (v1) {
          ...
          throw new Error("Failed pattern match at Day5 line 51, column 1 - line 51, column 39: " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  ...
  var extract = function (pos) {
      return function (polymer) {
          ...
          throw new Error("Failed pattern match at Day5 line 37, column 10 - line 42, column 31: " + [ polymer.constructor.name ]);
      };
  };
  var dropAll = function (letter) {
      return function (string) {
          ...
          throw new Error("Failed pattern match at Day5 line 82, column 5 - line 84, column 25: " + [ v.constructor.name ]);
      };
  };
      ...
      return function ($copy_polymer) {
          ...
          function $tco_loop(pos, polymer) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  throw new Error("Failed pattern match at Day5 line 73, column 27 - line 75, column 42: " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Day5 line 71, column 24 - line 75, column 42: " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var solve1 = function ($38) {
      return plength(condense(0)(makePolymer($38)));
  };
  var part1 = function ($39) {
      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(solve1($39)));
  };
  var solve2 = function (letter) {
      return function (input) {
          return function __do() {
              Effect_Console.log("Solving for " + letter)();
              var res = solve1(dropAll(letter)(input));
              Effect_Console.log(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(res))();
              return res;
          };
      };
  };
  var part2 = function (input) {
      return function __do() {
          Effect_Console.log("Calculating stage1s")();
          var v = Data_Traversable.traverse(Data_Traversable.traversableArray)(Effect.applicativeEffect)(Data_Function.flip(solve2)(input))(letters)();
          return Data_Show.show(Data_Maybe.showMaybe(Data_Maybe.showMaybe(Data_Show.showInt)))(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Functor.map(Data_Functor.functorFn)(Data_Array.head)(Data_Array.sort(Data_Ord.ordInt)))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Data_Maybe.applicativeMaybe)(v)));
      };
  };
...
(function(exports) {
  ...
  var part1 = function (input) {
      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Show.show(Data_Maybe.showMaybe(Data_Tuple.showTuple(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "x";
      }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
          return "y";
      }))(Data_Show.showRecordFieldsNil)(Data_Show.showInt))(Data_Show.showInt)))(Data_Show.showInt)))(solve1(input)));
  };
  var solve2 = function (input) {
  ...
  var part2 = function (input) {
      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(solve2(input)));
  };
