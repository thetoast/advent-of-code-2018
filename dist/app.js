...
(function(exports) {
  ...
  var unsafeInt = function ($35) {
      return Data_Maybe.fromJust()(Data_Int.fromString($35));
  };
              ...
              return function (v) {
                  return Data_Maybe.Just.create((function () {
                      ...
                      if (accM instanceof Data_Maybe.Just) {
                          var $29 = Data_Ord.greaterThan(dictOrd)(accM.value0.value1)(v.value1);
                          if ($29) {
                              return accM.value0;
                          };
                          return v;
  ...
  var log$prime = function (dictMonadTell) {
      return function ($36) {
          return Control_Monad_Writer_Class.tell(dictMonadTell)(Data_List.singleton($36));
      };
  };
  var throwLog = function (dictMonadTell) {
      return function (dictMonadError) {
          return function (str) {
              return Control_Bind.discard(Control_Bind.discardUnit)(((dictMonadError.MonadThrow0()).Monad0()).Bind1())(log$prime(dictMonadTell)(str))(function () {
                  return Control_Monad_Error_Class.throwError(dictMonadError.MonadThrow0())([ str ]);
              });
          };
      };
  };
...
(function(exports) {
  ...
  var width = function (v) {
      return v.maxX - v.minX | 0;
  };
  var updateBounds$prime = function (v) {
      return function (star) {
          return {
              maxX: Data_Ord.max(Data_Ord.ordInt)(star.position.x)(v.maxX),
              maxY: Data_Ord.max(Data_Ord.ordInt)(star.position.y)(v.maxY),
              minX: Data_Ord.min(Data_Ord.ordInt)(star.position.x)(v.minX),
              minY: Data_Ord.min(Data_Ord.ordInt)(star.position.y)(v.minY)
          };
      };
  };
  var starRegex = Data_Either.hush(Data_String_Regex.regex("position=<\\s*(-?\\d+),\\s+(-?\\d+)> velocity=<\\s*(-?\\d+),\\s+(-?\\d+)>")(Data_String_Regex_Flags.noFlags));
  var solve2 = Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Util["log'"](Control_Monad_State_Trans.monadTellStateT(Control_Monad_Except_Trans.monadTellExceptT(Control_Monad_Writer_Trans.monadTellWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))("Part 2 started"))(function () {
      return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))("Part 2");
  });
  var prettyPrint = function (v) {
      return function (stars) {
          var updateX = function (x) {
              return function (col) {
                  return Data_Maybe.fromJust()(Data_Array.updateAt(x)("#")(col));
              };
          };
          var updateStar = function (starMap) {
              return function (v1) {
                  return Data_Maybe.fromJust()(Data_Array.modifyAt(v1.y)(function (a) {
                      return updateX(v1.x)(a);
                  })(starMap));
              };
          };
          var normalize = function (v1) {
              return {
                  x: v1.position.x - v.minX | 0,
                  y: v1.position.y - v.minY | 0
              };
          };
          var setStars = function (stars$prime) {
              return function (starMap) {
                  return Data_Foldable.foldl(Data_List_Types.foldableList)(updateStar)(starMap)(Data_Functor.map(Data_List_Types.functorList)(normalize)(stars$prime));
              };
          };
          var initStarMap = Data_Functor.map(Data_Functor.functorArray)(function (v1) {
              return Data_Functor.map(Data_Functor.functorArray)(function (v2) {
                  return ".";
              })(Data_Array.range(v.minX)(v.maxX));
          })(Data_Array.range(v.minY)(v.maxY));
          return Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)("\x0a")(Data_Functor.map(Data_Functor.functorArray)(Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(""))(setStars(stars)(initStarMap)));
      };
  };
  var parseStar = function (pat) {
      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))))(function (v) {
          var v1 = Data_List.uncons(v.input);
          if (v1 instanceof Data_Maybe.Nothing) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(function (s) {
                  var $59 = {};
                  for (var $60 in s) {
                  ...
                  $59.input = v1.value0.tail;
                  return $59;
              }))(function () {
                  return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Util["except'"]("bad match")(Data_String_Regex.match(pat)(v1.value0.head)))(function (v2) {
                      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Util["except'"]("could not read x pos")(Data_Functor.map(Data_Maybe.functorMaybe)(Util.unsafeInt)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.index(v2)(1)))))(function (v3) {
                          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Util["except'"]("could not read y pos")(Data_Functor.map(Data_Maybe.functorMaybe)(Util.unsafeInt)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.index(v2)(2)))))(function (v4) {
                              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Util["except'"]("could not read x vel")(Data_Functor.map(Data_Maybe.functorMaybe)(Util.unsafeInt)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.index(v2)(3)))))(function (v5) {
                                  return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Util["except'"]("could not read y vel")(Data_Functor.map(Data_Maybe.functorMaybe)(Util.unsafeInt)(Control_Bind.join(Data_Maybe.bindMaybe)(Data_Array_NonEmpty.index(v2)(4)))))(function (v6) {
          ...
          throw new Error("Failed pattern match at Day10 line 83, column 3 - line 92, column 78: " + [ v1.constructor.name ]);
      });
  };
  var initialState = {
      input: Data_List_Types.Nil.value,
      bounds: Data_Maybe.Nothing.value,
      stars: Data_List_Types.Nil.value,
      steps: 0
  };
  var part2 = Util.runSubprogram(solve2)(initialState);
  var height = function (v) {
      return v.maxY - v.minY | 0;
  };
  var boundsFromStar = function (v) {
      return {
          maxX: v.position.x,
          maxY: v.position.y,
          minX: v.position.x,
  ...
  var determineBounds = function (stars) {
      var initBounds = boundsFromStar(Data_List_NonEmpty.head(stars));
      return Data_Foldable.foldl(Data_List_Types.foldableNonEmptyList)(updateBounds$prime)(initBounds)(stars);
  };
  var updateBounds = function (v) {
      return function (star) {
          if (v instanceof Data_Maybe.Nothing) {
              return boundsFromStar(star);
          };
          if (v instanceof Data_Maybe.Just) {
              return updateBounds$prime(v.value0)(star);
          };
          throw new Error("Failed pattern match at Day10 line 51, column 1 - line 51, column 47: " + [ v.constructor.name, star.constructor.name ]);
      };
  };
  var moveStars = (function () {
      var updateStars = function (v) {
          return function (v1) {
              var newPos = {
                  x: v.position.x + v.velocity.x | 0,
                  y: v.position.y + v.velocity.y | 0
              };
              var newStar = {
                  position: newPos,
                  velocity: v.velocity
              };
              var newBounds = Data_Maybe.Just.create(updateBounds(v1.bounds)(newStar));
              return {
                  stars: new Data_List_Types.Cons(newStar, v1.stars),
                  bounds: newBounds
              };
          };
      };
      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))))(function (v) {
          ...
          var v1 = Data_Foldable.foldr(Data_List_Types.foldableList)(updateStars)(acc)(v.stars);
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Class.put(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))((function () {
              ...
              $87.stars = v1.stars;
              $87.bounds = v1.bounds;
              $87.steps = v.steps + 1 | 0;
              return $87;
          })()))(function () {
              if (v.bounds instanceof Data_Maybe.Nothing) {
                  return Util.throwLog(Control_Monad_State_Trans.monadTellStateT(Control_Monad_Except_Trans.monadTellExceptT(Control_Monad_Writer_Trans.monadTellWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Trans.monadErrorStateT(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))("bounds cannot be empty");
              };
              if (v.bounds instanceof Data_Maybe.Just) {
                  if (v1.bounds instanceof Data_Maybe.Nothing) {
                      return Util.throwLog(Control_Monad_State_Trans.monadTellStateT(Control_Monad_Except_Trans.monadTellExceptT(Control_Monad_Writer_Trans.monadTellWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Trans.monadErrorStateT(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))("newBounds cannot be empty");
                  };
                  if (v1.bounds instanceof Data_Maybe.Just) {
                      var $92 = width(v.bounds.value0) < width(v1.bounds.value0);
                      if ($92) {
                          return Util.throwLog(Control_Monad_State_Trans.monadTellStateT(Control_Monad_Except_Trans.monadTellExceptT(Control_Monad_Writer_Trans.monadTellWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Trans.monadErrorStateT(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))("bounds getting wider");
                      };
                      var $93 = height(v.bounds.value0) < height(v1.bounds.value0);
                      if ($93) {
                          return Util.throwLog(Control_Monad_State_Trans.monadTellStateT(Control_Monad_Except_Trans.monadTellExceptT(Control_Monad_Writer_Trans.monadTellWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Trans.monadErrorStateT(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))("bounds getting taller");
                      };
                  ...
                  throw new Error("Failed pattern match at Day10 line 104, column 7 - line 111, column 29: " + [ v1.bounds.constructor.name ]);
              };
              throw new Error("Failed pattern match at Day10 line 101, column 3 - line 111, column 29: " + [ v.bounds.constructor.name ]);
          });
      });
  })();
  var solve1 = Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Util["except'"]("bad regex")(starRegex))(function (v) {
      return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_Reader_Class.ask(Control_Monad_State_Trans.monadAskStateT(Control_Monad_Except_Trans.monadAskExceptT(Control_Monad_Writer_Trans.monadAskWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadAskReaderT(Data_Identity.monadIdentity))))))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(function (s) {
              var $103 = {};
              for (var $104 in s) {
              ...
              $103.input = Data_List.fromFoldable(Data_Foldable.foldableArray)(Util.splitLines(v1));
              return $103;
          }))(function () {
              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(parseStar(v))(function (v2) {
                  return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Data_List.many(Control_Monad_State_Trans.alternativeStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(Control_Monad_Except_Trans.alternativeExceptT(Data_Monoid.monoidArray)(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Trans.lazyStateT)(parseStar(v)))(function (v3) {
                      var stars = new Data_NonEmpty.NonEmpty(v2, v3);
                      var bounds = determineBounds(stars);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Class.modify_(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(function (s) {
                          var $108 = {};
                          for (var $109 in s) {
                          ...
                          $108.stars = Data_List_NonEmpty.toList(stars);
                          $108.bounds = new Data_Maybe.Just(bounds);
                          return $108;
                      }))(function () {
                          return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Data_List.manyRec(Control_Monad_State_Trans.monadRecStateT(Control_Monad_Except_Trans.monadRecExceptT(Control_Monad_Writer_Trans.monadRecWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadRecReaderT(Control_Monad_Rec_Class.monadRecIdentity)))))(Control_Monad_State_Trans.alternativeStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))(Control_Monad_Except_Trans.alternativeExceptT(Data_Monoid.monoidArray)(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(moveStars))(function (v4) {
                              return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity))))))(function (v5) {
                                  return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Writer_Trans.monadWriterT(Data_List_Types.monoidList)(Control_Monad_Reader_Trans.monadReaderT(Data_Identity.monadIdentity)))))("Steps: " + (Data_Show.show(Data_Show.showInt)(v5.steps) + ("\x0a" + (Data_Show.show(Data_Maybe.showMaybe(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                                      return "maxX";
                                      ...
                                      return "minY";
                                  }))(Data_Show.showRecordFieldsNil)(Data_Show.showInt))(Data_Show.showInt))(Data_Show.showInt))(Data_Show.showInt))))(v5.bounds) + ("\x0a" + prettyPrint(Data_Maybe.fromJust()(v5.bounds))(v5.stars))))));
                              });
                          });
                      });
                  });
  ...
  exports["boundsFromStar"] = boundsFromStar;
  exports["updateBounds"] = updateBounds;
  exports["determineBounds"] = determineBounds;
  exports["height"] = height;
  exports["width"] = width;
  exports["starRegex"] = starRegex;
