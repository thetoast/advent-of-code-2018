...
(function(exports) {
  ...
  var extract = function (pos) {
      return function (polymer) {
          ...
          throw new Error("Failed pattern match at Day5 line 32, column 10 - line 37, column 31: " + [ polymer.constructor.name ]);
      };
  };
      ...
      return function ($copy_polymer) {
          ...
          function $tco_loop(pos, polymer) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  ...
                  if (v1) {
                      $tco_done = true;
                      return deleteAt(pos)(pos + 1 | 0)(polymer);
                  };
                  if (!v1) {
                      $tco_var_pos = pos + 1 | 0;
                  ...
                  throw new Error("Failed pattern match at Day5 line 68, column 27 - line 70, column 42: " + [ v1.constructor.name ]);
              };
              throw new Error("Failed pattern match at Day5 line 66, column 24 - line 70, column 42: " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var condenseR = function ($copy_polymer) {
      ...
      function $tco_loop(polymer) {
          var res = condense(0)(polymer);
          var $32 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(plength(res))(plength(polymer));
          if ($32) {
              $tco_done = true;
              return res;
          };
  ...
  var solve1 = function ($33) {
      return plength(condenseR(makePolymer($33)));
  };
  var part1 = function ($34) {
      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(solve1($34)));
  };
