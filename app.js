...
(function(exports) {
  ...
  var Effect_Console = PS["Effect.Console"];
  var Prelude = PS["Prelude"];                 
  var words$prime = Data_String_Common.split("\x0a");
  ...
  var hasN = function (n) {
      return function (input) {
          var updateLetterCount = function (cur) {
              ...
              throw new Error("Failed pattern match at Day2 line 31, column 33 - line 35, column 1: " + [ cur.constructor.name ]);
          };
  ...
  var getSum = function (input) {
      var words = Data_List.fromFoldable(Data_Foldable.foldableArray)(words$prime(input));
  ...
  var collectDiffsOfN = function ($copy_n) {
      return function ($copy_words) {
          ...
          function $tco_loop(n, words) {
              ...
              throw new Error("Failed pattern match at Day2 line 55, column 5 - line 62, column 23: " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
