...
(function(exports) {
  ...
  var dropAll = function (letter) {
      return function (string) {
          ...
          throw new Error("Failed pattern match at Day5 line 88, column 5 - line 90, column 25: " + [ v.constructor.name ]);
      };
  };
  ...
  var solve1 = function ($39) {
      return plength(condense(0)(makePolymer($39)));
  };
  var part1 = function ($40) {
      return Control_Applicative.pure(Effect.applicativeEffect)(Data_Show.show(Data_Maybe.showMaybe(Data_Show.showInt))(solve1($40)));
  };
